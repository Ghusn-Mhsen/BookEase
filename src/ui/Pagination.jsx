...
export default function Pagination({ count }) {
  ...
  function nextPage() {
    ...
    const next = currentPage === numPage ? currentPage : currentPage + 1;
  ...
  return (
    <StyledPagination>
      <p>
        Showing <span>{(currentPage - 1) * PAGE_SIZE + 1}</span> to <span>{currentPage === numPage ? count : currentPage * PAGE_SIZE}</span> of <span>{count}</span> results
      </p>
      <Buttons>
